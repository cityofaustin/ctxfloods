...
type ChangeStatusDurationNamePayload {
  ...
  # Reads a single 'Status' that is related to this 'StatusDuration'.
...
type Community implements Node {
  ...
  # Reads and enables paginatation through a set of 'CommunityCrossing'.
  communityCrossingsByCommunityId(
    # The method to use when ordering 'CommunityCrossing'.
    orderBy: CommunityCrossingsOrderBy = PRIMARY_KEY_ASC
    ...
    # A condition to be used in determining which values should be returned by the collection.
    condition: CommunityCrossingCondition
  ): CommunityCrossingsConnection
}
...
# A relation between a crossing and a community.
type CommunityCrossing implements Node {
  # A globally unique identifier. Can be used in various places throughout the system to identify this single value.
  __id: ID!

  # The primary key for the community crossing relation.
  id: Int!
  ...
  # Reads a single 'Community' that is related to this 'CommunityCrossing'.
  communityByCommunityId: Community

  # Reads a single 'Crossing' that is related to this 'CommunityCrossing'.
  crossingByCrossingId: Crossing
}

# A condition to be used against 'CommunityCrossing' object types. All fields are
# tested for equality and combined with a logical ‘and.’
input CommunityCrossingCondition {
  # Checks for equality with the object’s 'id' field.
  id: Int
...
# A connection to a list of 'CommunityCrossing' values.
type CommunityCrossingsConnection {
  # Information to aid in pagination.
  pageInfo: PageInfo!

  # The count of *all* 'CommunityCrossing' you could get from the connection.
  totalCount: Int

  # A list of edges which contains the 'CommunityCrossing' and cursor to aid in pagination.
  edges: [CommunityCrossingsEdge]

  # A list of 'CommunityCrossing' objects.
  nodes: [CommunityCrossing!]
}

# A 'CommunityCrossing' edge in the connection.
type CommunityCrossingsEdge {
  # A cursor for use in pagination.
  cursor: Cursor

  # The 'CommunityCrossing' at the end of the edge.
  node: CommunityCrossing!
}

# Methods to use when ordering 'CommunityCrossing'.
enum CommunityCrossingsOrderBy {
  PRIMARY_KEY_ASC
  PRIMARY_KEY_DESC
  NATURAL
  ID_ASC
...
type Crossing implements Node {
  ...
  # Gets the latest status of a given crossing.
...
type Query implements Node {
  ...
  # Reads a single 'CommunityCrossing' using its globally unique 'ID'.
  communityCrossing(
    # The globally unique 'ID' to be used in selecting a single 'CommunityCrossing'.
    __id: ID!
  ): CommunityCrossing
  communityCrossingById(
    # The primary key for the community crossing relation.
    id: Int!
  ): CommunityCrossing
...
type StatusDuration implements Node {
  ...
  # The id of the status the duration applies to.
  statusId: Int!
