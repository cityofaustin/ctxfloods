  ...
  render() {
    return (
        <div>
          ...
          <PrivateRoute path="/dashboard/users" component={UserList} authenticated={auth.isAuthenticated()} authorized={auth.roleAuthorized(['floods_community_admin', 'floods_super_admin'])} />
