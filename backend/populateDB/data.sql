...
-- Add crossings
insert into floods.crossing (id, name, human_address, description, coordinates, human_coordinates) values
  (1, 'park', 'at the park', 'Crossing at the park', ST_MakePoint(-97.768, 30.267), ST_AsLatLonText(ST_MakePoint(-97.768, 30.267))),
  (2, 'school', 'at the school', 'Crossing at the school', ST_MakePoint(-97.768, 30.267), ST_AsLatLonText(ST_MakePoint(-97.768, 30.267))),
  (3, 'library', 'at the library', 'Crossing at the library', ST_MakePoint(-97.768, 30.267), ST_AsLatLonText(ST_MakePoint(-97.768, 30.267))),
  (4, 'capitol', 'at the capitol', 'Crossing at the capitol', ST_MakePoint(-97.768, 30.267), ST_AsLatLonText(ST_MakePoint(-97.768, 30.267))),
  (5, 'city hall', 'at city hall', 'Crossing at city hall', ST_MakePoint(-97.768, 30.267), ST_AsLatLonText(ST_MakePoint(-97.768, 30.267))),
  (6, 'coffee shop', 'at the coffee shop', 'Crossing at the coffee shop', ST_MakePoint(-97.768, 30.267), ST_AsLatLonText(ST_MakePoint(-97.768, 30.267))),
  (7, 'other community', 'in the other community', 'Crossing in the other community', ST_MakePoint(-97.768, 30.267), ST_AsLatLonText(ST_MakePoint(-97.768, 30.267))),
  (8, 'other community 2', 'another in the other community', 'Another crossing in the other community', ST_MakePoint(-97.768, 30.267), ST_AsLatLonText(ST_MakePoint(-97.768, 30.267)));
